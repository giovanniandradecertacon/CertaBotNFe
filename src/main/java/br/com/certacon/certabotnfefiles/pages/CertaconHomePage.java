...
public class CertaconHomePage {
    ...
    public NfeStatusForSeleniumSchedule closeAndNavigate(RemoteWebDriver remoteWebDriver) throws MalformedURLException {
        NfeStatusForSeleniumSchedule homePageStatus = null;
        ...
        try {
                    ...
                    if (filterElement.isPresent()) {
                        ...
                        if (efdElement.isPresent()) {
                            ...
                            if (uploadFilesElement.isPresent()) {
                                homePageStatus = NfeStatusForSeleniumSchedule.CHANGED;
                            }
                        }
                    }
                }
            ...
            homePageStatus = NfeStatusForSeleniumSchedule.ERROR;
